...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MYOTHETPC\\MSSQLSERVER2012;Database=DotNetTrainingBatch4;User Id=sa;Password=admin123!;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblPizzaExtra>(entity =>
        {
            ...
            entity.Property(e => e.PizzaExtraName).HasMaxLength(50);
            entity.Property(e => e.Price).HasColumnType("decimal(18, 2)");
        });
        ...
        {
            entity.HasKey(e => e.PizzaOrderDetailsId);

            entity.ToTable("Tbl_PizzaOrderDetails");
